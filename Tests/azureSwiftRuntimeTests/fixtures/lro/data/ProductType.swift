import Foundation
public struct ProductType : ProductTypeProtocol, ResourceTypeProtocol {
    public var id: String?
    public var type: String?
    public var tags: [String:String?]?
    public var location: String?
    public var name: String?
    public var properties: ProductPropertiesTypeProtocol?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.properties) {
        properties = try container.decode(ProductPropertiesType?.self, forKey: .properties)
    }
  }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.properties != nil {try container.encode(properties as! ProductPropertiesType?, forKey: .properties)}
  }
}
