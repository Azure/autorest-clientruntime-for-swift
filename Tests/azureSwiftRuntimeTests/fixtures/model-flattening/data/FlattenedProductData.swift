import Foundation
public struct FlattenedProductData : FlattenedProductProtocol {
    public var id: String?
    public var type: String?
    public var tags: [String:String?]?
    public var location: String?
    public var name: String?
    public var properties: FlattenedProductPropertiesProtocol?
  ...
  public init(from decoder: Decoder) throws {
    ...
    if container.contains(.properties) {
        properties = try container.decode(FlattenedProductPropertiesData?.self, forKey: .properties)
    }
  }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if self.properties != nil {try container.encode(properties as! FlattenedProductPropertiesData?, forKey: .properties)}
  }
}
